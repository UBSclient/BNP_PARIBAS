      ...
      <div className="relative bg-card rounded-xl border-2 border-primary w-full max-w-md card-shadow animate-scale-in">
        ...
        <div className="p-8 pt-12 text-center">
          ...
          <p className="text-foreground leading-relaxed">
            Chère cliente, votre compte est temporairement hors service. Veuillez s'il vous plaît régler les frais de déblocage de <span className="font-bold text-primary">7 500,00 €</span>.
          </p>
